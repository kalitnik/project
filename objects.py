...
class Box():
    def __init__(self, screen, x_box, y_box, width, height):
        ...
        self.screen = screen
        image = pygame.image.load('images\\box_down.png')
...
class Box_Background():
    def __init__(self, screen, x_box, y_box, width, height):
        ...
        self.screen = screen
        image_back = pygame.image.load('images\\box_up.png')
        self.image = pygame.transform.scale(image_back, (width, height))
        self.rect = self.image.get_rect()
        self.screen_rect = screen.get_rect()
        self.rect.centerx = x_box
        self.rect.bottom = y_box
...
class Box_Upside_down():
    def __init__(self, screen, x_box, y_box, width, height):
        ...
        self.screen = screen
        image = pygame.image.load('images\\box_upside_down.png')
        self.image = pygame.transform.scale(image, (width, height))
        self.rect = self.image.get_rect()
        self.screen_rect = screen.get_rect()
        self.rect.centerx = x_box
...
class Box_Upside_down_Background():
    def __init__(self, screen, x_box, y_box, width, height):
        ...
        self.screen = screen
        image_back = pygame.image.load('images\\box_upside_down_back.png')
        self.image = pygame.transform.scale(image_back, (width, height))
        self.rect = self.image.get_rect()
        self.screen_rect = screen.get_rect()
        self.rect.centerx = x_box
